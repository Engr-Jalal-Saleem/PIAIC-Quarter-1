...
let fruits: string[] = ["Apple", "Orange", "Banana", "Mango", "Grapes", "Watermelon", "Strawberry", "Kiwi", "Pineapple"];
console.log("Fruits:",fruits);
let push1: number = fruits.push("Papaya");
...
//10. concat() - joins two arrays
let fruits2: string[] = ["Guava", "Pomegranate", "Cherry"];
...
/* In TypeScript, the `export { };` statement is used to indicate that the file is a module and exports
nothing. It is commonly used at the end of a file to explicitly state that the file is a module,
even if it doesn't export any variables, functions, or classes. */
export { };